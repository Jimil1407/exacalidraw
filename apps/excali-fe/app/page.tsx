...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Navigation */}
      <nav className="flex items-center justify-between p-6 border-b border-cyan-500/20">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-cyan-500/10 to-cyan-600/10">
